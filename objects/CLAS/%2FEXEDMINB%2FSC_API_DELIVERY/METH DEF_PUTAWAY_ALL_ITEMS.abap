  METHOD def_putaway_all_items.
    ...
    lo_function = mo_model->create_function( 'PUTAWAY_ALL_ITEMS' ).
    lo_function->set_edm_name( 'PutawayAllItems' ) ##NO_TEXT.
    ...
    lo_function_import = lo_function->create_function_import( 'PUTAWAY_ALL_ITEMS' ).
    lo_function_import->set_edm_name( 'PutawayAllItems' ) ##NO_TEXT.
