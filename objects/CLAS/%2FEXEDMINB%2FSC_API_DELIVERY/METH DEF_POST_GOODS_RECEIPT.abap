  METHOD def_post_goods_receipt.
    ...
    lo_function = mo_model->create_function( 'POST_GOODS_RECEIPT' ).
    lo_function->set_edm_name( 'PostGoodsReceipt' ) ##NO_TEXT.
    ...
    lo_function_import = lo_function->create_function_import( 'POST_GOODS_RECEIPT' ).
    lo_function_import->set_edm_name( 'PostGoodsReceipt' ) ##NO_TEXT.
