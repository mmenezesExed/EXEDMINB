  METHOD def_putaway_one_item.
    ...
    lo_function = mo_model->create_function( 'PUTAWAY_ONE_ITEM' ).
    lo_function->set_edm_name( 'PutawayOneItem' ) ##NO_TEXT.
    ...
    lo_function_import = lo_function->create_function_import( 'PUTAWAY_ONE_ITEM' ).
    lo_function_import->set_edm_name( 'PutawayOneItem' ) ##NO_TEXT.
