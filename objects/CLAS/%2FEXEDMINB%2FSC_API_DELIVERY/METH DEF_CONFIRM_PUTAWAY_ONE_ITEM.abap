  METHOD def_confirm_putaway_one_item.
    ...
    lo_function = mo_model->create_function( 'CONFIRM_PUTAWAY_ONE_ITEM' ).
    lo_function->set_edm_name( 'ConfirmPutawayOneItem' ) ##NO_TEXT.
    ...
    lo_function_import = lo_function->create_function_import( 'CONFIRM_PUTAWAY_ONE_ITEM' ).
    lo_function_import->set_edm_name( 'ConfirmPutawayOneItem' ) ##NO_TEXT.
