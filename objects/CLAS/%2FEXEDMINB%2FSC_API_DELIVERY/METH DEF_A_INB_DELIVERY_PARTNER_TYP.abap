  METHOD def_a_inb_delivery_partner_typ.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'A_INB_DELIVERY_PARTNER_TYP'
                                    is_structure              = VALUE tys_a_inb_delivery_partner_typ( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'A_InbDeliveryPartnerType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'A_INB_DELIVERY_PARTNER' ).
    lo_entity_set->set_edm_name( 'A_InbDeliveryPartner' ) ##NO_TEXT.
    ...
    lo_navigation_property->set_target_entity_type_name( 'A_INB_DELIVERY_ADDRESS_TYP' ).
