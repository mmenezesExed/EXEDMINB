  METHOD def_a_material_document_item_t.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'A_MATERIAL_DOCUMENT_ITEM_T'
                                    is_structure              = VALUE tys_a_material_document_item_t( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'A_MaterialDocumentItemType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'A_MATERIAL_DOCUMENT_ITEM' ).
    lo_entity_set->set_edm_name( 'A_MaterialDocumentItem' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'INVENTORY_STOCK_TYPE' ).
    lo_primitive_property->set_edm_name( 'InventoryStockType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'MANUFACTURING_ORDER_ITEM' ).
    lo_primitive_property->set_edm_name( 'ManufacturingOrderItem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GOODS_MOVEMENT_REF_DOC_TYP' ).
    lo_primitive_property->set_edm_name( 'GoodsMovementRefDocType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'DELIVERY' ).
    lo_primitive_property->set_edm_name( 'Delivery' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'DELIVERY_ITEM' ).
    lo_primitive_property->set_edm_name( 'DeliveryItem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_BASE_UNIT_ISOCODE' ).
    lo_primitive_property->set_edm_name( 'MaterialBaseUnitISOCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_BASE_UNIT_SAPCODE' ).
    lo_primitive_property->set_edm_name( 'MaterialBaseUnitSAPCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ENTRY_UNIT_ISOCODE' ).
    lo_primitive_property->set_edm_name( 'EntryUnitISOCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'ENTRY_UNIT_SAPCODE' ).
    lo_primitive_property->set_edm_name( 'EntryUnitSAPCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'GDS_MVT_EXT_AMT_IN_CO_CODE' ).
    lo_primitive_property->set_edm_name( 'GdsMvtExtAmtInCoCodeCrcy' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SLS_PRC_AMT_INCL_VATIN_CO' ).
    lo_primitive_property->set_edm_name( 'SlsPrcAmtInclVATInCoCodeCrcy' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Decimal' ) ##NO_TEXT.
    lo_primitive_property->set_precision( 14 ) ##NUMBER_OK.
    lo_primitive_property->set_scale( 3 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'FISCAL_YEAR_PERIOD' ).
    lo_primitive_property->set_edm_name( 'FiscalYearPeriod' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ISSUING_OR_RECEIVING_STOCK' ).
    lo_primitive_property->set_edm_name( 'IssuingOrReceivingStockType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'ISSUING_OR_RECEIVING_VAL_T' ).
    lo_primitive_property->set_edm_name( 'IssuingOrReceivingValType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SERIAL_NUMBERS_ARE_CREATED' ).
    lo_primitive_property->set_edm_name( 'SerialNumbersAreCreatedAutomly' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'RESERVATION_ITEM_RECORD_TY' ).
    lo_primitive_property->set_edm_name( 'ReservationItemRecordType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SPECIAL_STOCK_IDFG_SALES_O' ).
    lo_primitive_property->set_edm_name( 'SpecialStockIdfgSalesOrder' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SPECIAL_STOCK_IDFG_SALES_2' ).
    lo_primitive_property->set_edm_name( 'SpecialStockIdfgSalesOrderItem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'SPECIAL_STOCK_IDFG_WBSELEM' ).
    lo_primitive_property->set_edm_name( 'SpecialStockIdfgWBSElement' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 24 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_DOCUMENT_LINE' ).
    lo_primitive_property->set_edm_name( 'MaterialDocumentLine' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_DOCUMENT_PARENT_L' ).
    lo_primitive_property->set_edm_name( 'MaterialDocumentParentLine' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 6 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'HIERARCHY_NODE_LEVEL' ).
    lo_primitive_property->set_edm_name( 'HierarchyNodeLevel' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GOODS_MOVEMENT_IS_CANCELLE' ).
    lo_primitive_property->set_edm_name( 'GoodsMovementIsCancelled' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'Boolean' ) ##NO_TEXT.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REVERSED_MATERIAL_DOCUMENT' ).
    lo_primitive_property->set_edm_name( 'ReversedMaterialDocumentYear' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REVERSED_MATERIAL_DOCUME_2' ).
    lo_primitive_property->set_edm_name( 'ReversedMaterialDocument' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'REVERSED_MATERIAL_DOCUME_3' ).
    lo_primitive_property->set_edm_name( 'ReversedMaterialDocumentItem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'INVTRY_MGMT_REF_DOCUMENT_I' ).
    lo_primitive_property->set_edm_name( 'InvtryMgmtRefDocumentItem' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 4 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INVTRY_MGMT_REFERENCE_DOCU' ).
    lo_primitive_property->set_edm_name( 'InvtryMgmtReferenceDocument' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 10 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_DOCUMENT_POSTING' ).
    lo_primitive_property->set_edm_name( 'MaterialDocumentPostingType' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'INVENTORY_USABILITY_CODE' ).
    lo_primitive_property->set_edm_name( 'InventoryUsabilityCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_navigation_property = lo_entity_type->create_navigation_property( 'TO_MATERIAL_DOCUMENT_HEADE' ).
    lo_navigation_property->set_edm_name( 'to_MaterialDocumentHeader' ) ##NO_TEXT.
    lo_navigation_property->set_target_entity_type_name( 'A_MATERIAL_DOCUMENT_HEAD_2' ).
    ...
    lo_navigation_property->set_target_entity_type_name( 'A_SERIAL_NUMBER_MATERIAL_2' ).
