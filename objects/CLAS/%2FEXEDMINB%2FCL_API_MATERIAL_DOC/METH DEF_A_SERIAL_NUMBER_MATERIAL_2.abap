  METHOD def_a_serial_number_material_2.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'A_SERIAL_NUMBER_MATERIAL_2'
                                    is_structure              = VALUE tys_a_serial_number_material_2( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'A_SerialNumberMaterialDocumentType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'A_SERIAL_NUMBER_MATERIAL_D' ).
    lo_entity_set->set_edm_name( 'A_SerialNumberMaterialDocument' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'SERIAL_NUMBER_IS_RECURSIVE' ).
    lo_primitive_property->set_edm_name( 'SerialNumberIsRecursive' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
