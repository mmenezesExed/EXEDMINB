  METHOD def_a_material_document_head_2.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'A_MATERIAL_DOCUMENT_HEAD_2'
                                    is_structure              = VALUE tys_a_material_document_head_2( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'A_MaterialDocumentHeaderType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'A_MATERIAL_DOCUMENT_HEADER' ).
    lo_entity_set->set_edm_name( 'A_MaterialDocumentHeader' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'MATERIAL_DOCUMENT_HEADER_T' ).
    lo_primitive_property->set_edm_name( 'MaterialDocumentHeaderText' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    ...
    lo_primitive_property = lo_entity_type->get_primitive_property( 'VERSION_FOR_PRINTING_SLIP' ).
    lo_primitive_property->set_edm_name( 'VersionForPrintingSlip' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'MANUAL_PRINT_IS_TRIGGERED' ).
    lo_primitive_property->set_edm_name( 'ManualPrintIsTriggered' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'CTRL_POSTG_FOR_EXT_WHSE_MG' ).
    lo_primitive_property->set_edm_name( 'CtrlPostgForExtWhseMgmtSyst' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 1 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'GOODS_MOVEMENT_CODE' ).
    lo_primitive_property->set_edm_name( 'GoodsMovementCode' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 2 ) ##NUMBER_OK.
    lo_primitive_property->set_is_nullable( ).
    ...
    lo_navigation_property = lo_entity_type->create_navigation_property( 'TO_MATERIAL_DOCUMENT_ITEM' ).
    lo_navigation_property->set_edm_name( 'to_MaterialDocumentItem' ) ##NO_TEXT.
    lo_navigation_property->set_target_entity_type_name( 'A_MATERIAL_DOCUMENT_ITEM_T' ).
