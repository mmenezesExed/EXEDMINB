  METHOD def_cancel.
    ...
    lo_parameter->set_primitive_type( 'MATERIAL_DOCUMENT_YEAR' ).
    ...
    lo_parameter->set_primitive_type( 'MATERIAL_DOCUMENT' ).
    lo_parameter->set_is_nullable( ).
    ...
    lo_return->set_entity_type( 'A_MATERIAL_DOCUMENT_HEAD_2' ).
